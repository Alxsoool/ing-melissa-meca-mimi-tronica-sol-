...
**Respuesta:** 
- Inductivo: acero, porque conduce bien.
- Capacitivo: agua o madera húmeda, por su constante dieléctrica.
- Óptico: plásticos o madera opaca, reflejan mejor la luz.
- Magnético: imán, porque es lo que activa el sensor.
---
### 5.4 ¿Detectaron zonas muertas o inestabilidad? 
**Respuesta:**
Sí. 
- Óptico: a largas distancias y con materiales brillantes.
- Capacitivo: con humedad o cercanía de objetos.
- Inductivo: cerca del límite de alcance.
- Magnético: estable, pero solo con imán.
---
### 5.5 ¿Este sensor sería adecuado para la situación problema del curso? 
**Respuesta:**
Depende: 
- Inductivo: bueno para piezas metálicas, barato.
- Capacitivo: útil para líquidos o materiales no metálicos, pero sensible.
